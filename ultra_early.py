...
ACTION_BUY_MIN_MCAP = max(1.0, _float("ACTION_BUY_MIN_MARKET_CAP_USD", 10_000))
...
STRONG_BREAKOUT_MAX_AGE_SECONDS = max(300, _int("STRONG_BREAKOUT_MAX_AGE_SECONDS", 480))
...
STRONG_BREAKOUT_MIN_VOLUME_MCAP_RATIO = max(0.20, _float("STRONG_BREAKOUT_MIN_VOLUME_MCAP_RATIO", 0.35))
...
def _moonshot_override_ok(snap, result) -> bool:
    """Rare high-momentum exception above the normal $20k-$55k BUY band."""
